...
public class GuiTheAltening extends GuiScreen {
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                Hypnotic.instance.APIKey = api.getText();
    ...
    {
        String text;
        if (Hypnotic.instance.APIKey != null && Hypnotic.instance.APIKey != "" && (api == null || api.getText() == null || api.getText() == "")) {
            text = Hypnotic.instance.APIKey;
        } else {
            text = api.getText();
        }
        int startChar = 10;
