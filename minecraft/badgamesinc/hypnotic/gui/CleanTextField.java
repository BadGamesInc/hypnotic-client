...
public class CleanTextField extends Gui
{
    private final int id;
    private SigmaFontRenderer fontRendererInstance = FontManager.jelloFont;
    ...
    /** 0 = Default, 1 = Comfortaa, 2 = Jello font, 3 = Roboto **/
    private int fontType = 0;
    

    public CleanTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
        this.xPosition = x;
        this.yPosition = y;
    ...
    public CleanTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, int fontType)
    {
        this.id = componentId;
        this.xPosition = x;
        this.yPosition = y;
        ...
        switch(fontType) {
    	case 0:
    		fontRendererInstance = FontManager.roboto2;
    		break;
    	case 1:
    		fontRendererInstance = FontManager.comfortaa;
    		break;
    	case 2:
    		fontRendererInstance = FontManager.jelloFont;
    		break;
    	case 3:
    		fontRendererInstance = FontManager.roboto;
    		break;
        }
    }
