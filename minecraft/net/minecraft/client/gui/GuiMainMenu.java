...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
       ...
       // this.drawGradientRect(0, 0, this.width, this.height, 0, Integer.MIN_VALUE);
        ...
        changes.add("§a+ Added NCP bypasses to KillAura AutoBlock, NoSlow, and Speed");
        changes.add("§a+ Added AutoConfig as a temp fix to configs being broken :/");
        changes.add("§a+ Added Phase");
        changes.add("§a+ Added LongJump");
        changes.add("§a+ Added AntiBot");
        changes.add("§a+ Added .enchant");
        changes.add("§a+ Added .help");
        changes.add("§a+ Added .about");
        changes.add("§a+ Added .help");
        changes.add("§e* Improved Nametags");
        changes.add("§e* Changed font renderer because the other one sucked");
        changes.add("§e* Improved TargetHUD");
        changes.add("§e* Fixed KillSults");
        changes.add("§e* Fixed Disabler");
        changes.add("§e* Fixed InfoHUD TPS display");
        changes.add("§e* Improved PC Pinger");
        changes.add("§e* Rewrote the ClickGUI");
        changes.add("§e* Replaced retard talk with retard detector");
        changes.add("§c- Removed Tracers (temp)");

        bigFontRenderer.drawString("Changes", 4, 4, -1, false);
        
        int count = 0;
        for (String str : changes) {
            //fontRenderer.drawString("§e*", 16, 112, -1, true);
            count += 10;
        }
